...
prefs.w1Size = [0 0 400 400]; %[0 0 1680 1100];
...
% if issueflag
    outputfile = fopen([savedir '/bcl_sub' num2str(prefs.subID) '_test_' datestr(now,'mm-dd-yyyy_HH-MM') '.txt'],'a');
% else
%     outputfile = fopen([savedir '/bcl_sub' num2str(prefs.subID) '_test_day' num2str(prefs.day) '.txt'],'a');
% end
...
% if issueflag
    save(fullfile(savedir, ['bcl_sub' num2str(prefs.subID) '_test_' datestr(now,'mm-dd-yyyy_HH-MM') '.mat']))
% else
%     save(fullfile(savedir, ['bcl_sub' num2str(prefs.subID) '_test.mat']))
% end
Screen('FillRect', prefs.w1, prefs.backColor);
...
% copyfile(fullfile(savedir, ['sub' num2str(prefs.subID) '_test*.mat']), fullfile(localdir, 'data'))
% copyfile(fullfile(savedir, ['sub' num2str(prefs.subID) '_test*.txt']), fullfile(localdir, 'data'))
